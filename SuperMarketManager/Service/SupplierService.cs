...
namespace SuperMarketManager.Service
{
    public class SupplierService
    {
        ...
        public bool AddSupplier(String name, String phone, String address, String remark)
        {
            return DatabaseTool.ExecSql(String.Format(INSERT_SUPPLIER_SQL, name, phone, address, remark));
        }
