<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test_employee.aspx.cs" Inherits="SuperMarketManager.View.test_employee" %>
            ...
            <div style="text-align:left;margin-top:15px;margin-left:70px;">
               ...
               <%-- <asp:Button ID="emp_update" runat="server" Text="修改" class="btn_delete"/>
                ...
                <asp:TableHeaderRow CssClass="header-font asp-table-header">
                    <asp:TableHeaderCell CssClass="table-bordered td text-center ">XXX</asp:TableHeaderCell>
